  ...
  return (
    <div>
      <div className="forgotpw-container">
        {/* LOGO */}
        <header className="forgotpw-logo">
        ...
        {/* LEFT SECTION */}
        <div className="forgotpw-leftSection">
          <form className="forgotpw-form">
          <div className="forgotpw-hdLogin">
            <div className="forgotpw-title-row">
            ...
            <div className="forgotpw-input-group">
              <TextField 
                sx={{  width: '100%' }}
                id="email" 
                label={"Email address"} 
        ...
        {/* RIGHT SECTION */}
        <div className="forgotpw-rightSection">
          <div className="forgotpw-svg-container">
          ...
          <div className="forgotpw-stats">
            <p>Over 2 Candidates joined us to have a F U C K I N G JOB</p>
            <div className="forgotpw-stats-row">
              {/* livejobs */}
              <div>
