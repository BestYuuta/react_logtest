...
import NewPassword from "../Components/_newpw.jsx"
import ComfirmPw from "../Components/_confirmPw.jsx"
    ...
    <div>
        <div className="resetpw-container">
            ...
            <form className="resetpw-form">
                <div className="resetpw-hd">
                <div className="resetpw-title-row">
